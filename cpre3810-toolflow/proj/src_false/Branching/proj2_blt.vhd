...
architecture mixed of proj2_blt is
    ...
    -- Original Code uses behavioral loops ONLY for managing wires. But we are not allowed to have behavioral at all
        -- AI used to turn behavioral into not behavioral. Original code kept to prove work
